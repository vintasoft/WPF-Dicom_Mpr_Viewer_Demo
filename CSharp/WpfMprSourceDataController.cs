...
namespace WpfDicomMprViewerDemo
{
    ...
    /// </summary>
    public sealed class WpfMprSourceDataController
    {
        ...
        /// </summary>
        Dictionary<DicomFrame, MprDicomImagePlanarSlice[]> _frameToMprSourceData = new Dictionary<DicomFrame, MprDicomImagePlanarSlice[]>();
        ...
        /// <summary>
        /// A value indicating whether the data filling process of the MPR image must be canceled.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WpfMprSourceDataController"/> class.
        /// </summary>
        public WpfMprSourceDataController()
        {
        ...
        private void LoadMprSourceData()
        {
            ...
            if (_mprSourceData == null)
            {
                ...
                foreach (DicomFile dicomFile in _dicomFiles)
                {
                    ...
                    sourceSlices.AddRange(WpfMprVisualizationController.CreateMprDicomImagePlanarSlice(dicomFile));
                }
