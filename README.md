# VintaSoft WPF DICOM MPR Viewer Demo
...
3. Build the project ("WpfDicomMprViewerDemo.Net10.csproj" file) in Visual Studio or using .NET CLI:
   ```
   dotnet build WpfDicomMprViewerDemo.Net10.csproj
   ```
